...
def tier_breakdown(df):
    ...
    # Recompute tiers like reconstruct_topology.py does
    EU_IB = 0.15
    US_IB = 0.10
    DERIV_MULT = 1.5
...
def liability_heatmap(df, W, top_n=20):
    ...
    # Sort by interbank assets like the topology code does
    ...
    # Row-scale to interbank liabilities
...
def main():
    ...
    print(f"\nAll files written to {FRONTEND_DATA}")
    print("Done.")
